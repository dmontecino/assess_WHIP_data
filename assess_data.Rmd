...
spec<-read_excel(file=params$path.to.file, sheet = 1, col_types = rep("text", number_of_columns))
...
obs<-read_excel(params$path.to.file, sheet = 2, col_types = rep("text", number_of_columns))
