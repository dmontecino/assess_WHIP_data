...
# 
dat=lapply(c(1:3), function(x) read_excel("/Users/DMontecino/Downloads/Data export_bevan_federko_2023-10-02.xlsx", sheet = x, col_types = "text"))
...
#
#
```{r sample quantity, echo=FALSE, warning=FALSE, eval=T, cache=F, message=FALSErt}
