...
```{r specimen no necropsy report, no necropsy level or no necropsy reported and no sample inventory, echo=FALSE, warning=FALSE, eval=F, cache=FALSE}
...
if(nrow(list.of.potential.observations.df)>0){  
  ...
  print("Yes, the data show that some specimens could be observations. These are the Specimen codes that do 
...
if(!exists("list.of.potential.observations.df") |
  ...
  print("No, all specimens have a necropsy (carcass) or samples associated")}
...
```{r funding project tag provided env specimens, echo=FALSE, warning=FALSE, eval=F, message=FALSE}
...
## SURVEILLANCE PROJECT TAG PROVIDED
#
```{r type of surveillance tag provided env specimens, echo=FALSE, warning=FALSE, eval=F, message=FALSE}
...
## SURVEILLANCE OUTBREAK UNIT
#
```{r surveillance or outbreak unit env specimens, echo=FALSE, warning=FALSE, eval=F, message=FALSE}
...
spec.pending.necropsy$Necropsy_pending="Yes" # test
