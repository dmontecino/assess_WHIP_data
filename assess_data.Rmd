...
sample.quantity.provided.df=
  ...
  print("No. The data has samples without their quantities.These are the samples whose quantity is not provided." )
...
sample.quantity.not.informative.df=
  ...
  print("No. The data has sample quantities that are not informative.These are the samples whose quantity is not informative." )
