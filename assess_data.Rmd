...
# }
# 
# using("knitr", "kableExtra", "readxl",
#       "stringi", "dplyr", "tibble", 
#       "rworldmap", "tidyverse", "plyr")
...
# specimen.codes.with.animal.ids.as.na.per.country=readRDS( "/Users/DMontecino/Desktop/test.RDS")
# lapply(specimen.codes.with.animal.ids.as.na.per.country,kableExtra::kable)
# kableExtra::kable(specimen.codes.with.animal.ids.as.na.per.country[[1]], 
#                   format = "html", 
#                   col.names = names(specimen.codes.with.animal.ids.as.na.per.country)[[1]])

number_of_columns=619 # counted the number of columns in the original excel


# spec<-read_excel("/Users/DMontecino/Desktop/Data export_diego_montecino_2021-01-21.xlsx", sheet = 1, col_types = rep("text", number_of_columns))
# spec<-read_excel("/Users/DMontecino/Desktop/Data export_diego_montecino_2021-03-09.xlsx", sheet = 1, col_types = rep("text", number_of_columns))
spec<-read_excel(path = params$path.to.file, sheet = 1, col_types = rep("text", number_of_columns))

# obs<-read_excel("/Users/DMontecino/Desktop/Data export_diego_montecino_2021-01-21.xlsx", sheet = 2, col_types = rep("text", number_of_columns))
obs<-read_excel(path = params$path.to.file, sheet = 2, col_types = rep("text", number_of_columns))
...
##### Do total seen, number healthy, number sick, and number dead match?

We cannot learn about this yes because the columns "Total seen", "Number healthy", "Number sick", and "Number dead" are not in the export but we have requested a solution to this problem.

```{r observation number, echo=FALSE, warning=FALSE, eval=F}
```
