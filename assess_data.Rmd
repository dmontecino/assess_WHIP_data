...
#
```{r repeated samples with and without tests single specimen, echo=FALSE, warning=FALSE, eval=T}
...
#
```{r tests that could be repeated almost same infomration, echo=FALSE, warning=FALSE, eval=T, cache=FALSE, message=FALSE}
