...
#
#
```{r repeated samples without tests dates, echo=FALSE, warning=FALSE, eval=T}
...
#
```{r repeated samples with and without tests, echo=FALSE, warning=FALSE, eval=T}
...
# spec.sample.ids.in.more.one.spec$Sample_quantity_missing="Yes"

# samples.no.test.but.repeated$Repeated_sample_id="Yes"

# samples.with.test.and.wo.test$Repeated_sample_is_2="Yes"
...
```
  ...
  #same sample used to test for the same disease a least twice (TRICKY): this can be correct but I can point suspects, specially if the test level data is the same 
...
test.sent.testing.earlier.than.sampling.date.df=
  ...
  print("No, the data show that some tests were sent for testing before the source sample was collectde date. These are the tests that were sent for testing before the source sample was collected")
...
<!-- ## Were the tests results received since the source specimens was found? -->

<!-- ## Were the tests results received since the samples were collected? -->


<!-- ## Were the tests results received since the test was sent for testing? -->
#
#
## TEST WITHOUT THE SOURCE
#
...
#
#
## TEST WITH RESULTS BUT WITHOUT THE DATE WHEN RESULTS WERE RECEIVED
#
...
#
#
## TEST WITH RESULTS RECEIVED FROM THE LAB BUT PENDING OR NO RESULT IN THE DATA
#
